...
def first_not_repeating_char(char_sequence):
    ...
    #lambda es una funcion por parametro, en este caso retorna todos los segundos elementos de la
    #lista enviado en el primer parametro (los indices de cada tupla), es como definir la siguiente función:
    #def sort_order(value):
    #   return value[1]
    not_repeated_letters = sorted(final_letters, key=lambda value: value[1])
    #Sorted es una función para ordenar colecciones que recibe la colección y como segundo parametro el criterio de ordenamiento
